...
### Структура сайта
### Header
![Сайт 1](images/site1.png)
### Аннотация сайта
![Сайт 2](images/site2.png)
### О проекте
![Сайт 3](images/site3.png)
### Участники проекта
![Сайт 4](images/site4.png)
### Журнал проекта
![Сайт 5](images/site5.png)
### Ресурсы
![Сайт 6](images/site6.png)
### Footer
![Сайт 7](images/site7.png)
### Завершение работы
После завершения работы над сайтом, сохраняем файл формата html и загружаем его в папку site вместе со всеми изображениями.
